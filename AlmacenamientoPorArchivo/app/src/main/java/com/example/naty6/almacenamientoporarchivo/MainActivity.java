package com.example.naty6.almacenamientoporarchivo;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void generarArchivo(View view){
        try{
            EditText texto = findViewById(R.id.et_contenido);
            String str = texto.getText().toString();
            FileOutputStream outputStream= null;
            outputStream = openFileOutput("MiArchivo",Context.MODE_APPEND);
